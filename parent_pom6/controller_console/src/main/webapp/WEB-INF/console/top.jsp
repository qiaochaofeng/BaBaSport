                              ...
                              <tr>
                                ...
                                <td>
                                	<ul class="nav-menu">
										...
										<li class="sep"></li><li class="normal" id="tb_12" onclick="HoverLi(12);"><a href="/brand/product_main.action" target="mainFrame">商品</a></li>
										<li class="sep"></li><li class="normal" id="tb_13" onclick="HoverLi(13);"><a href="frame/order_main.jsp" target="mainFrame">订单</a></li>
										<li class="sep"></li><li class="normal" id="tb_14" onclick="HoverLi(14);"><a href="/center/ad_main.action" target="mainFrame">广告</a></li>
