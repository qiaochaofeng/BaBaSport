...
function fqBrand(brandId) {
	window.location.href = "/seachProduct?keyword="+keyword+"&brandId=" + brandId+"&price="+price;
}

 function fqPrice(price){
 	window.location.href = "/seachProduct?keyword="+keyword+"&price=" + price+"&brandId="+brandId;
 }
			...
			<div class="gl-i-wrap">
				<div class="p-img">
					<a href="javascript:;" onclick="window.open('/product/detail?id=${product.id}')" style="position: relative;">
						<img width="220" height="220" class="err-product"  src="${product.imgs[0]}">
				...
				<div class="p-name p-name-type-2">
					<a target="_blank" title="满129立减10,199减20优惠券,支持货到付款" href="javascript:;" 
						onclick="window.open('http://localhost:8084/html/${product.id}.html')">
						<em>${product.name }</em>
					</a>
				</div>
				<div class="p-commit">
